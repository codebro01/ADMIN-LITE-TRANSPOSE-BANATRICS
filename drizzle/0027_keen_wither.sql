...
ALTER TABLE "bank_details" ALTER COLUMN "bankId" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "payments" ALTER COLUMN "date_initiated" SET DEFAULT now();--> statement-breakpoint
ALTER TABLE "driver_campaigns" ADD COLUMN "rejection_reason" varchar;--> statement-breakpoint
